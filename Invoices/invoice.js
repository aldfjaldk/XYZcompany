...
async function getDeliveryChallans() {
  try {
    const response = await fetch("http://localhost:8000/api/v1/auth/displayinvoice");
...
$(document).on("click", ".btn-danger", function () {
  ...
  $.ajax({
    url: "http://localhost:8000/api/v1/deleteinvoice/" + dcId,
    type: "DELETE",
...
$(document).on("click", ".btn-primary", function () {
  ...
  window.location.href = "./invoiceform.html"; // Redirect to the budget form page
});
...
$(document).on("click", ".btn-info", function () {
  ...
  var printContent = `
        ...
        <td style="padding: 8px; border: 1px solid #ccc;">${customerName}</td>
          ...
          <tr>
            <td style="padding: 8px; border: 1px solid #ccc; font-weight: bold;">Invoice:</td>
          ...
          <tr>
            <td style="padding: 8px; border: 1px solid #ccc; font-weight: bold;">Invoice Date:</td>
            <td style="padding: 8px; border: 1px solid #ccc;">${deliveryChallanDate}</td>
          </tr>
          <tr>
            <td style="padding: 8px; border: 1px solid #ccc; font-weight: bold;">Place of Supply:</td>
